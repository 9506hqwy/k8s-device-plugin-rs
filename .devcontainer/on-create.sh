...
sudo apt-get update
sudo apt-get install -y linux-perf protobuf-compiler shellcheck zstd
...
# Install grpcurl
GRPC_VERSION=1.9.3
curl -fsSL -o - "https://github.com/fullstorydev/grpcurl/releases/download/v${GRPC_VERSION}/grpcurl_${GRPC_VERSION}_linux_x86_64.tar.gz" | \
    tar -zxf - -O "grpcurl" > ~/.local/bin/grpcurl
